...
public class CRC16 {
    ...
    public static String checkCode(String str){
		byte[] bt=hexStr2Byte(str);
		int crc = CRC16.calcCrc16(bt);
		String checkcode=String.format("%04x", crc); 
		String end1=checkcode.substring(0, checkcode.length()-2);
    	String end2=checkcode.substring( checkcode.length()-2, checkcode.length());
		return end2+end1;
    	
    }
    
    public static boolean checkout(String string){
    	string=string.replaceAll(" ", "");
//    	System.out.println("全"+string);
    	String startcode=string.substring(0,string.length()-4);
    	String endcode=string.substring(string.length()-4,string.length()).toLowerCase();
//    	System.out.println("始"+startcode);
//    	System.out.println("尾"+endcode);
    	String end1=endcode.substring(0, endcode.length()-2);
    	String end2=endcode.substring( endcode.length()-2, endcode.length());
//    	System.out.println("前两位"+end1);
//    	System.out.println("后两位"+end2);
    	String endnew=end2+end1;
//    	System.out.println(endnew);
    	byte[] bt=hexStr2Byte(startcode);
//    	System.out.println(bt.length);
        int crc = CRC16.calcCrc16(bt);  
        String checkcode=String.format("%04x", crc); 
//        System.out.println("验"+checkcode);
        if(endnew.equals(checkcode)){
...
//        	System.out.println("FALSE");
    ...
    public static boolean matchCode(String message, String code){
        String number = code.substring(2,4);
        int checkLength = (Integer.parseInt(code.substring(8, 12), 16) * 2 + 5) * 2;
        if (number.equals(message.substring(2,4)) && message.length() == checkLength) return true;
        return false;
    }
